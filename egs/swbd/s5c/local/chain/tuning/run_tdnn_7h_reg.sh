#!/bin/bash
#tdnn_7h_reg is based on tdnn_7h, but adding spatial regularization layer
...
get_egs_stage=-10
speed_perturb=true
dir=exp/chain/tdnn_7h_reg  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
