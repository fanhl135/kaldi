...
class DropoutComponent : public RandomComponent {
 public:
  ...
  void SetDropoutProportion(BaseFloat dropout_proportion, bool dropout_per_frame = false) {
 ...
 private:
  ...
  // if dropout_per_frame_ is true, the dropout-mask matrix is randomly setted to zeros or ones;
  //
